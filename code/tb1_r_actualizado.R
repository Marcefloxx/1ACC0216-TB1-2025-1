...
# Grafico de histograma de estancias por noche durante la semanas 
e4.1 <-ggplot(df,aes(x = stays_in_week_nights,fill=hotel 
)) + 
  geom_histogram() + 
  labs(title = "Estancias por noche durante la semanas", x="Cantidad") + 
  theme_classic2() 
e4.1 

# Grafico de histograma de estancias por noche durante el fin de semana 
e4.2 <-ggplot(df,aes(x = stays_in_weekend_nights,fill=hotel 
)) + 
  
  geom_histogram() + 
  labs(title = "Estancias por noche durante el fin de semana ", x="Cantidad") + 
  theme_classic2() 
e4.2 

# Combinacion de ambos graficos 
e4.3<-(e4.1 | e4.2) + 
  plot_annotation(title = 'Estancias por noche durante la semanas y fin de semana',) 
e4.3 
